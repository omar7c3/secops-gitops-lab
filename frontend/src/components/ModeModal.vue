...
const SCENARIOS = {
  'privilege-escalation': {
    ...
    watch:    'Attack Feed for each step. System State panel for ArgoCD sync status and drift. Impact panel for the dwell time clock and stolen data sample.',
  ...
  'network-policy-bypass': {
    ...
    watch:    'Attack Feed for the Kyverno admission decision. System State panel for ArgoCD reconciling the deleted NetworkPolicy back. Impact panel for the lateral movement window timer.',
